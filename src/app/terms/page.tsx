                ...
                <div className="max-w-[80%] mx-auto">
                    ...
                    <section className="mb-6">
                        ...
                        <p className="text-white/90 text-justify">
                            En accédant ou en utilisant <strong>TITOMEET</strong> (le « Service »), vous acceptez les présentes Conditions, conclues avec <strong>Optimatech</strong>. Si vous refusez, vous devez cesser immédiatement toute utilisation.
                        </p>
                    </section>
                    ...
                    <section className="mb-6">
                        ...
                        <p className="text-white/90 mt-2">
                            Toute violation peut entraîner <strong>suppression immédiate du compte</strong> et signalement légal conformément à la Directive européenne DSA.
                        </p>
                    </section>
                    ...
                    <section className="mb-6">
                        ...
                        <p className="text-white/90">
                            Notre traitement des données est conforme au <strong>RGPD</strong>. Consultez notre <Link href="/confidentiality" className="underline hover:text-white/70">Politique de Confidentialité</Link>.
                        </p>
                    </section>
                    ...
                    <section className="mb-6">
                        ...
                        <p className="text-white/90">
                            Le Service est fourni <strong>« tel quel »</strong>, sans garantie légale ou implicite, sauf obligations prévues par la loi.
                        </p>
                    </section>
                    ...
                    <section className="mb-6">
                        ...
                        <p className="text-white/90">
                            Les présentes conditions sont régies par le droit français. Les litiges relèvent des juridictions françaises, après tentative de médiation via la <a href="https://ec.europa.eu/consumers/odr/" className="underline hover:text-white/70">plateforme ODR de l’UE</a>.
                        </p>
                    </section>
